...
export function ServicesSection({ onOpenBooking }: ServicesSectionProps) {
  return (
    <section className="relative py-24 bg-gradient-to-b from-white to-forest-50 overflow-hidden" id="services">
      {/* Decorative elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 bg-forest-200/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-forest-300/10 rounded-full blur-3xl" />
      </div>
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-700 mb-6">
              ...
              <span className="block text-forest-600">For You & The Planet</span>
            </h2>
